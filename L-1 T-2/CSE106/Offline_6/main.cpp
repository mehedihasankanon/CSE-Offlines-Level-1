...
int main()
{
    ...
    // ifstream MyReadFile("stress.txt");
    ...
    vector<int> testNum = numbers;

    clock_t time_of_stl_sorting_in_my_heap = clock();
    std::sort(numbers.begin(), numbers.end());

    cout << "Sorting " << numbers.size() << " numbers using stl takes " << float(clock() - time_of_stl_sorting_in_my_heap) / CLOCKS_PER_SEC << " seconds\n";

    clock_t time_of_sorting_in_my_heap = clock();
    ...
    cout << "Sorting " << numbers.size() << " numbers from my heap takes " << float(clock() - time_of_sorting_in_my_heap) / CLOCKS_PER_SEC << " seconds\n";
